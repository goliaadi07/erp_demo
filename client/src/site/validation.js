...
export const LIMITS = { firstName: 60, surname: 60, mobile: 20, email: 120, productId: 40, message: 600 };
...
export function validateQuote(values) {
  ...
  if (String(values.message || '').trim().length > LIMITS.message) errors.message = `Must be at most ${LIMITS.message} characters`;
